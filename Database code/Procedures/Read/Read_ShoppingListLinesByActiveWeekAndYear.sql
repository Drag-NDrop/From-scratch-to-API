...
-- Description:	Gets all shoppinglist lines for a given Week and Year
-- =============================================
CREATE PROCEDURE Read_ShoppingListLinesByActiveWeekAndYear
...
WHERE ShoppingList.ActiveForWeek = @ActiveWeek AND ShoppingList.ActiveYear = @ActiveYear
